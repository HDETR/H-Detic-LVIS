...
def add_detic_config(cfg):
    ...
    _C.MODEL.DETR.NUM_OBJECT_QUERIES_ONE2ONE = 300
    _C.MODEL.DETR.NUM_OBJECT_QUERIES_ONE2MANY = 0
    _C.MODEL.DETR.USE_CHECKPOINT = False
    _C.MODEL.DETR.K_ONE2MANY = 0

    _C.MODEL.DETR.USE_FED_LOSS = False
    _C.MODEL.DETR.WEAK_WEIGHT = 0.1

    # Tricks for DeformableDETR
    _C.MODEL.DETR.MIXED_SELECTION = False
    _C.MODEL.DETR.LOOK_FORWARD_TWICE = False
